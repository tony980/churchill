...
$sql="INSERT INTO `clients2`(`First Name`, `Last Name`, `Phone No`, `Email`, `seat`, `seatNos`, `Price`, `Event`)  VALUES ('$one','$two','$three','$four','$five','$six','$seven','$nine' ) ";
