...
$sql="INSERT INTO `clients3`(`First Name`, `Last Name`, `Phone No`, `Email`, `seat`, `seatNos`, `Price`, `Event`)  VALUES ('$one','$two','$three','$four','$five','$six','$seven','$nine' ) ";
if ($conn->query($sql) === TRUE) {

include('pdf.php');
	$file_name = md5(rand()) . '.pdf';
	$html_code = '<link rel="stylesheet" href="bootstrap.min.css">';
	$html_code = ' <div><h1><i>Churchill show Laugh Event </i></h1><br> <i><u>'.$nine.' Edition</u></i><p>
