 ...
 <div class="u-clearfix u-sheet u-sheet-1">
   <div class="container mt-5">
    ...
    ?>
            ...
            <form method="POST" action="updateevent1.php">
              <h2 style="text-align: center;"><u>Update Event1 Info( <?php echo $title; ?> Edition)</u></h2>
                ...
                <input type="integer" placeholder="vip  payment amount " class="form-control my-3 bg-dark text-white text-center" name="vip" value="">
                <input type="text" placeholder="regular payment amount" class="form-control my-3 bg-dark text-white text-center" name="regular" value="" required="">
                <input type="datetime-local" placeholder="date of event" class="form-control my-3 bg-dark text-white text-center" name="date" value="" required="">
                 <input type="text" placeholder="Total available seats for event" class="form-control my-3 bg-dark text-white text-center" name="seat" value="" required="">
